...
import { orderService, paymentService, getSession } from '../../services';
  ...
  useEffect(() => {
    const fetchOrders = async () => {
      ...
      try {
        ...
        setError(
          axiosError.message || 'Failed to fetch orders. Please try again later.'
        );
        setLoading(false);
            ...
            orders.map((order) => (
              ...
              >
                ...
                <div className="mt-6 flex justify-end">
                  {order.payment &&(order.orderStatus === 'COMPLETED' ||
